...
const moduleTitles: Record<ModuleKey, { eyebrow: string; title: string; description: string }> = {
  ...
  reunioes: { eyebrow: "Operação colegiada", title: "Reuniões", description: "Conduza cada encontro do agendamento Ã  publicação da ata." },
...
const meetings = [
  { day: "28", month: "AGO", title: "24Âª Reunião Ordinária", council: "Conselho Municipal de Saúde", time: "14:00 â€” 16:30", status: "Confirmada", tone: "confirmed" },
  { day: "30", month: "AGO", title: "Câmara Técnica de Orçamento", council: "Conselho de Desenvolvimento Urbano", time: "09:00 â€” 11:00", status: "Pauta em revisão", tone: "review" },
  { day: "02", month: "SET", title: "Sessão deliberativa", council: "Conselho de Educação", time: "14:00 â€” 17:00", status: "Convocação pendente", tone: "pending" },
];
...
const documents = [
  { type: "ATA", title: "Ata da 23Âª Reunião Ordinária", context: "Conselho Municipal de Saúde Â· 14 ago. 2026", status: "Publicado", file: "PDF Â· 1,8 MB" },
  { type: "RES", title: "Resolução nÂº 18/2026", context: "Conselho de Educação Â· 12 ago. 2026", status: "Publicado", file: "PDF Â· 842 KB" },
  { type: "PAUTA", title: "Pauta da 24Âª Reunião Ordinária", context: "Conselho Municipal de Saúde Â· 28 ago. 2026", status: "Em revisão", file: "DOCX Â· 364 KB" },
  { type: "REL", title: "Relatório de presença â€” 2Âº trimestre", context: "Gestão institucional Â· 10 ago. 2026", status: "Interno", file: "XLSX Â· 210 KB" },
];
...
function CivicRail({ active }: { active: ModuleKey }) {
  const context: Record<ModuleKey, [string, string, string, string]> = {
    dashboard: ["Ciclo 08/2026", "14 reuniões registradas", "36 decisões catalogadas", "Próximo ato: reunião ordinária Â· hoje, 14h"],
    ...
    pautas: ["Organização de pauta", "Itens ordenados", "Relatorias identificadas", "Próximo ato: submeter pauta Ã  aprovação"],
    votacoes: ["Registro de deliberação", "Votos vinculados Ã  pauta", "Resultado preservado", "Próximo ato: abrir sessão de votação"],
    ...
    <div className="space-y-8">
      <section className="grid overflow-hidden border border-[#DDE2DB] bg-[#FCFBF7] lg:grid-cols-[1fr_286px]">
        ...
        <aside className="relative overflow-hidden bg-[#173F34] p-6 text-white">
          ...
          <div className="relative mt-7"><div className="font-editorial text-[47px] font-semibold leading-none tracking-[-0.07em]">14:00</div><p className="mt-2 text-[13px] font-semibold">24Âª Reunião Ordinária</p><p className="mt-1 max-w-[210px] text-[14px] leading-5 text-[#DCE9DD]">Conselho Municipal de Saúde Â· Sala Plenária</p></div>
